    ...
    return (
        <LazyMotion features={domAnimation}>
            ...
            >
                ...
                ></div>
                <div className="from-[#f8f9ff] pointer-events-none absolute inset-y-0 left-0 w-1/2 bg-gradient-to-r"></div>
                <div className="from-[#f8f9ff] pointer-events-none absolute inset-y-0 right-0 w-1/2 bg-gradient-to-l"></div>
